...
public class ViewFriendAdapter extends RecyclerView.Adapter<ViewFriendAdapter.ViewHolder> {
    ...
    public ViewFriendAdapter(List<Friend> friends, Context context) {
    ...
    @NonNull
    @Override
    public ViewFriendAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_friend, viewGroup, false);
        return new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewFriendAdapter.ViewHolder viewHolder, final int i) {
